 ...
 * @LastEditTime: 2022-06-09 22:34:44
 * @LastEditors: Zhang Bochun
 * @Description: 中心为2个交换机, 左侧连接到若干 sender, 右侧连接到若干 receiver
 * @FilePath: /ns-3.33/scratch/loss-cubic/topology.cc
 */
...
int main (int argc, char *argv[])
{
    ...
    foldname += " - cubic - " + std::to_string(loss_rate);
    ...
    std::string sendSocketFactory = "ns3::TcpSocketFactory";
