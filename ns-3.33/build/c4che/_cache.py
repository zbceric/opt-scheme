...
CC = ['/usr/bin/gcc']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Wno-unused-parameter', '-O0', '-ggdb', '-g3', '-Wall', '-Wno-unused-parameter', '-std=c++11', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-ffunction-sections', '-isystem', '/home/zhangbochun/tools/anaconda3/include', '-fdebug-prefix-map=/tmp/build/80754af9/python-split_1631797238431/work=/usr/local/src/conda/python-3.9.7', '-fdebug-prefix-map=/home/zhangbochun/tools/anaconda3=/usr/local/src/conda-prefix', '-O3']
CFLAGS_PYEXT = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-ffunction-sections', '-isystem', '/home/zhangbochun/tools/anaconda3/include', '-fdebug-prefix-map=/tmp/build/80754af9/python-split_1631797238431/work=/usr/local/src/conda/python-3.9.7', '-fdebug-prefix-map=/home/zhangbochun/tools/anaconda3=/usr/local/src/conda-prefix', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
...
CXX = ['/usr/bin/g++']
CXXDEFINES = ['_DEBUG']
CXXFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Wno-unused-parameter', '-std=c++11', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
CXXFLAGS_GTK = ['-pthread']
CXXFLAGS_MACBUNDLE = ['-fPIC']
CXXFLAGS_PTHREAD = '-pthread'
CXXFLAGS_PYEMBED = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-ffunction-sections', '-isystem', '/home/zhangbochun/tools/anaconda3/include', '-fdebug-prefix-map=/tmp/build/80754af9/python-split_1631797238431/work=/usr/local/src/conda/python-3.9.7', '-fdebug-prefix-map=/home/zhangbochun/tools/anaconda3=/usr/local/src/conda-prefix', '-O3']
CXXFLAGS_PYEXT = ['-march=nocona', '-mtune=haswell', '-ftree-vectorize', '-fPIC', '-fstack-protector-strong', '-fno-plt', '-O3', '-ffunction-sections', '-isystem', '/home/zhangbochun/tools/anaconda3/include', '-fdebug-prefix-map=/tmp/build/80754af9/python-split_1631797238431/work=/usr/local/src/conda/python-3.9.7', '-fdebug-prefix-map=/home/zhangbochun/tools/anaconda3=/usr/local/src/conda-prefix', '-O3', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['ipv6', 'channel-models', 'udp', 'traffic-control', 'energy', 'wireless', 'tutorial', 'naming', 'udp-client-server', 'stats', 'matrix-topology', 'realtime', 'tcp', 'routing', 'error-model', 'socket']
...
INCLUDES_PYEMBED = ['/home/zhangbochun/tools/anaconda3/include/python3.9', '/home/zhangbochun/tools/anaconda3/include']
INCLUDES_PYEXT = ['/home/zhangbochun/tools/anaconda3/include/python3.9', '/home/zhangbochun/tools/anaconda3/include']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_BOOST = ['/usr/lib/x86_64-linux-gnu']
LIBPATH_PYEMBED = ['/home/zhangbochun/tools/anaconda3/lib/python3.9/config-3.9-x86_64-linux-gnu', '/home/zhangbochun/tools/anaconda3/lib']
LIBPATH_PYEXT = ['/home/zhangbochun/tools/anaconda3/lib/python3.9/config-3.9-x86_64-linux-gnu', '/home/zhangbochun/tools/anaconda3/lib']
LIBPATH_ST = '-L%s'
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/zhangbochun/zbc_study/opt-scheme/ns-3.33/build/lib', '/home/zhangbochun/zbc_study/opt-scheme/ns-3.33/build']
...
PYO = 1
PYTAG = 'cpython-39'
PYTHON = ['/home/zhangbochun/tools/anaconda3/bin/python3']
PYTHONARCHDIR = '/usr/local/lib/python3.9/site-packages'
PYTHONDIR = '/usr/local/lib/python3.9/site-packages'
PYTHON_CONFIG = ['/home/zhangbochun/tools/anaconda3/bin/python3-config']
PYTHON_VERSION = '3.9'
...
cfg_files = ['/home/zhangbochun/zbc_study/opt-scheme/ns-3.33/build/ns3/config-store-config.h', '/home/zhangbochun/zbc_study/opt-scheme/ns-3.33/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
