      ...
      if ((node != 0) && (ipv4 != 0 || ipv6 != 0))
        {
          ...
          Ptr<SendTcpSocketFactory> sendTcpFactory = CreateObject<SendTcpSocketFactory> ();
          sendTcpFactory->SetTcp (this);
          node->AggregateObject (sendTcpFactory);

          Ptr<PaceTcpSocketFactory> paceTcpFactory = CreateObject<PaceTcpSocketFactory> ();
          paceTcpFactory->SetTcp (this);
          node->AggregateObject (paceTcpFactory);
        }
    }
